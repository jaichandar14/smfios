...
class LandingViewController: UIViewController {
    ...
    static func create() -> LandingViewController {
    ...
    func setUpMenuBar() {
        ...
        self.sideMenuViewController.closeMenu = { () in
...
extension LandingViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int, key: MenuKey) {
        ...
        case .availability:
            ...
            break
        case .logout:
            showAlert(withTitle: "Logout", withMessage: "Are you sure want to logout?", isDefault: false, actions: [
                UIAlertAction(title: "Cancel", style: .cancel),
                UIAlertAction(title: "OK", style: .destructive, handler: { action in
                    AmplifyLoginUtility.signOut { signoutStatus in
                        print("Signout Status:: \(signoutStatus)")
...
extension UIViewController {
    ...
    func revealViewController() -> LandingViewController? {
        var viewController: UIViewController? = self
        
        if viewController != nil && viewController is LandingViewController {
            return viewController! as? LandingViewController
        }
        while (!(viewController is LandingViewController) && viewController?.parent != nil) {
